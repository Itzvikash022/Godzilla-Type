...
function Practice() {
  ...
  const handleCustomInputChange = (text: string, fromAI = false) => {
  ...
  const handleAIGenerated = (text: string) => {
    handleCustomInputChange(text, true);
  };
        ...
        <div className="relative w-full max-w-[1500px] mx-auto py-8 select-none mb-8">
          ...
          <div className="flex items-end justify-between mb-3">
            <div>
              ...
              {isAIGenerated && (
                <span className="inline-block mt-1 text-[10px] uppercase tracking-widest font-bold text-main bg-main/10 px-2 py-0.5 rounded border border-main/20 animate-fade-in">
